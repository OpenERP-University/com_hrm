...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_hrm&task=positionstypes.saveOrderAjax&tmpl=component';
	JHtml::_('sortablelist.sortable', 'positionstypeList', 'adminForm', strtolower($listDirn), $saveOrderingUrl);
}
...
<?php endif;?>
		...
		<table class="table table-striped" id="positionstypeList">
			...
			<?php foreach ($this->items as $i => $item) :
                ...
                <?php if (isset($this->items[0]->state)): ?>
					<td class="center">
						<?php echo JHtml::_('jgrid.published', $item->state, $i, 'positionstypes.', $canChange, 'cb'); ?>
					</td>
                <?php endif; ?>
                    
				<td>

                                    <a href = "<?php echo JRoute::_('index.php?option=com_hrm&view=positionstype&layout=edit&id='.$item->id); ?>"  >	<?php echo $item->title; ?></a>
				</td>
				<td>
