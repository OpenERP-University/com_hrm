...
if ($saveOrder) {
    $saveOrderingUrl = 'index.php?option=com_hrm&task=employees.saveOrderAjax&tmpl=component';
...
function Link(id) {
      ...
      window.location.href = '<?php echo JRoute::_('index.php?option=com_hrm&view=employee&layout=edit&id=', false, 2)  ?>' + id;
            ...
            <table class="table " id="employeeList">
                ...
                <tbody>
                    ...
                    foreach ($this->items as $i => $item) :
                        ...
                        <tr  onMousedown="this.style.backgroundColor='#66CCFF';"  onMouseover = "this.style.backgroundColor='#FFFF99';"  onMouseout = "this.style.backgroundColor='#FFFFFF';">
                            ...
                            <?php if (isset($this->items[0]->id)): ?>
                                <td class="center hidden-phone" onclick="Link(<?php echo $item->id; ?>)">
