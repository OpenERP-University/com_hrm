...
if ($saveOrder) {
    $saveOrderingUrl = 'index.php?option=com_hrm&task=scale_types.saveOrderAjax&tmpl=component';
    JHtml::_('sortablelist.sortable', 'scale_typeList', 'adminForm', strtolower($listDirn), $saveOrderingUrl);
}
...
foreach ($this->items as $i => $item) :
    ...
    <?php if (isset($this->items[0]->ordering)): ?>
                            ...
                            <?php if (isset($this->items[0]->state)): ?>
                                <td class="center">
                                    <?php echo JHtml::_('jgrid.published', $item->state, $i, 'scale_types.', $canChange, 'cb'); ?>
                                </td>
                            <?php endif; ?>

                            <td>

                                <a href = "<?php echo JRoute::_('index.php?option=com_hrm&view=scale_type&layout=edit&id=' . $item->id); ?>"  >	<?php echo $item->title; ?> </a>
                            </td>
                            <td>
