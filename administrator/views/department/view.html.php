 ...
 * View to edit
 */
class HrmViewDepartment extends JViewLegacy {
    ...
    protected function addToolbar() {
        ...
        JToolBarHelper::title(JText::_('COM_HRM_TITLE_DEPARTMENT'), 'department.png');
        ...
        if (empty($this->item->id)) {
            ...
            if ($this->state->params->get('save_history', 0) && $user->authorise('core.edit')) {
                JToolbarHelper::versions('com_hrm.department', $this->item->id);
            }
