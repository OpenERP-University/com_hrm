 ...
 */
class HrmViewDepartments extends JViewLegacy {
    ...
    public function display($tpl = null) {
        ...
        HrmHelper::addSubmenu('departments');
    ...
    protected function addToolbar() {
        ...
        JToolBarHelper::title(JText::_('COM_HRM_TITLE_DEPARTMENTS'), 'departments.png');
        ...
        JHtmlSidebar::setAction('index.php?option=com_hrm&view=departments');
        ...
        $form = JForm::getInstance('com_hrm.department', 'department');
	...
	protected function getSortFields()
	{
		...
		'a.title' => JText::_('COM_HRM_DEPARTMENTS_TITLE'),
		'a.department_guid' => JText::_('COM_HRM_DEPARTMENTS_DEPARTMENT_GUID'),
		);
	}
