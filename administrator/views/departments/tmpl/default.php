...
if ($saveOrder) {
    $saveOrderingUrl = 'index.php?option=com_hrm&task=departments.saveOrderAjax&tmpl=component';
...
foreach ($this->items as $i => $item) :
    ...
    <?php if (isset($this->items[0]->ordering)): ?>
                            ...
                            <td>
                                ...
                                <a href = "<?php echo JRoute::_('index.php?option=com_hrm&view=department&layout=edit&id=' . $item->id); ?>"  >	<?php echo $item->title; ?></a>
                            </td>
                            <td>
