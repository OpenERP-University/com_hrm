...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_hrm&task=scale_groups.saveOrderAjax&tmpl=component';
	JHtml::_('sortablelist.sortable', 'scale_groupList', 'adminForm', strtolower($listDirn), $saveOrderingUrl);
}
...
<?php endif;?>
		...
		<table class="table table-striped" id="scale_groupList">
			...
			<?php foreach ($this->items as $i => $item) :
                ...
                <?php if (isset($this->items[0]->state)): ?>
					<td class="center">
						<?php echo JHtml::_('jgrid.published', $item->state, $i, 'scale_groups.', $canChange, 'cb'); ?>
					</td>
                <?php endif; ?>
                    
				<td>

                                    <a href = "<?php echo JRoute::_('index.php?option=com_hrm&view=scale_group&layout=edit&id='.$item->id); ?>"  >	<?php echo $item->title; ?> </a>
				</td>
				<td>
