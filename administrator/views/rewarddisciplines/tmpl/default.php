...
if ($saveOrder) {
    $saveOrderingUrl = 'index.php?option=com_hrm&task=rewarddisciplines.saveOrderAjax&tmpl=component';
    JHtml::_('sortablelist.sortable', 'rewarddisciplineList', 'adminForm', strtolower($listDirn), $saveOrderingUrl);
}
...
foreach ($this->items as $i => $item) :
    ...
    <?php if (isset($this->items[0]->ordering)): ?>
                            ...
                            <?php if (isset($this->items[0]->state)): ?>
                                <td class="center">
                                    <?php echo JHtml::_('jgrid.published', $item->state, $i, 'rewarddisciplines.', $canChange, 'cb'); ?>
                                </td>
                            <?php endif; ?>
