...
<script type="text/javascript">
    ...
    js(document).ready(function () {
        ...
        js('input:hidden.positiontype_guid').each(function () {
            var name = js(this).attr('name');
            if (name.indexOf('positiontype_guidhidden')) {
                js('#jform_positiontype_guid option[value="' + js(this).val() + '"]').attr('selected', true);
            }
        });
        js("#jform_positiontype_guid").trigger("liszt:updated");
...
<form action="<?php echo JRoute::_('index.php?option=com_hrm&layout=edit&id=' . (int) $this->item->id); ?>" method="post" enctype="multipart/form-data" name="adminForm" id="position-form" class="form-validate">
