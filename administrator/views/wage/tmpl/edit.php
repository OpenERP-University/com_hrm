...
<script type="text/javascript">
    ...
    {
        if (task == 'wage.cancel') {
            Joomla.submitform(task, document.getElementById('wage-form'));
        }
        else {
            
            if (task != 'wage.cancel' && document.formvalidator.isValid(document.id('wage-form'))) {
...
<form action="<?php echo JRoute::_('index.php?option=com_hrm&layout=edit&id=' . (int) $this->item->id); ?>" method="post" enctype="multipart/form-data" name="adminForm" id="wage-form" class="form-validate">

    <div class="form-horizontal">
        <?php echo JHtml::_('bootstrap.startTabSet', 'myTab', array('active' => 'general')); ?>

        <?php echo JHtml::_('bootstrap.addTab', 'myTab', 'general', JText::_('COM_HRM_TITLE_WAGE', true)); ?>
        <div class="row-fluid">
