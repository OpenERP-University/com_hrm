...
/**
 * Coefficients list controller class.
 */
class HrmControllerCoefficients extends JControllerAdmin
{
	/**
	 * Proxy for getModel.
	 * @since	1.6
	 */
	public function getModel($name = 'coefficient', $prefix = 'HrmModel', $config = array())
	{
