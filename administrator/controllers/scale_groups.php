...
/**
 * Scale_groups list controller class.
 */
class HrmControllerScale_groups extends JControllerAdmin
{
	/**
	 * Proxy for getModel.
	 * @since	1.6
	 */
	public function getModel($name = 'scale_group', $prefix = 'HrmModel', $config = array())
	{
