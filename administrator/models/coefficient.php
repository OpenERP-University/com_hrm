 ...
 * Hrm model.
 */
class HrmModelCoefficient extends JModelAdmin
{
	/**
	...
	protected $text_prefix = 'COM_HRM';
        public $typeAlias = 'com_hrm.coefficient';
	...
	public function getForm($data = array(), $loadData = true)
	{
		...
		// Get the form.
		$form = $this->loadForm('com_hrm.coefficient', 'coefficient', array('control' => 'jform', 'load_data' => $loadData));
	...
	protected function prepareTable($table)
	{
		...
		if (empty($table->id)) {
			...
			if (@$table->ordering === '') {
				$db = JFactory::getDbo();
				$db->setQuery('SELECT MAX(ordering) FROM #__hrm_coefficient');
				$max = $db->loadResult();
