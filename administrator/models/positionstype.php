 ...
 * Hrm model.
 */
class HrmModelPositionstype extends JModelAdmin
{
	/**
	...
	protected $text_prefix = 'COM_HRM';
        public $typeAlias = 'com_hrm.positionstype';
	...
	public function getForm($data = array(), $loadData = true)
	{
		...
		// Get the form.
		$form = $this->loadForm('com_hrm.positionstype', 'positionstype', array('control' => 'jform', 'load_data' => $loadData));
	...
	protected function prepareTable($table)
	{
		...
		if (empty($table->id)) {
			...
			if (@$table->ordering === '') {
				$db = JFactory::getDbo();
				$db->setQuery('SELECT MAX(ordering) FROM #__hrm_positionstype');
				$max = $db->loadResult();
