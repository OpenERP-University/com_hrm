...
class HrmModelPositions extends JModelList {
    ...
    protected function populateState($ordering = null, $direction = null) {
		...
		$this->setState('filter.positiontype_guid', $app->getUserStateFromRequest($this->context.'.filter.positiontype_guid', 'filter_positiontype_guid', '', 'string'));
    ...
    protected function getListQuery() {
        ...
        if (!empty($search)) {
            if (stripos($search, 'id:') === 0) {
                ...
                $query->where('( a.employee_guid LIKE '.$search.'  OR  a.positiontype_guid LIKE '.$search.'  OR  a.department_guid LIKE '.$search.' )');
            }
        }
