 ...
 * Hrm model.
 */
class HrmModelScale_group extends JModelAdmin {
    ...
    public $typeAlias = 'com_hrm.scale_group';
    ...
    public function getForm($data = array(), $loadData = true) {
        ...
        // Get the form.
        $form = $this->loadForm('com_hrm.scale_group', 'scale_group', array('control' => 'jform', 'load_data' => $loadData));
    ...
    protected function prepareTable($table) {
        ...
        if (empty($table->id)) {
            ...
            if (@$table->ordering === '') {
                $db = JFactory::getDbo();
                $db->setQuery('SELECT MAX(ordering) FROM #__hrm_scale_group');
                $max = $db->loadResult();
