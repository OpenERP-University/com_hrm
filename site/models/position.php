 ...
 * Hrm model.
 */
class HrmModelPosition extends JModelItem {
		...
		if ( isset($this->_item->created_by) ) {
			...
			if (isset($this->_item->employee_guid) && $this->_item->employee_guid != '') {
				...
				foreach ($values as $value){
					...
					if ($results) {
						$textValue[] = $results->descriptions;
					}
				}
			...
			if (isset($this->_item->positiontype_guid) && $this->_item->positiontype_guid != '') {
				if(is_object($this->_item->positiontype_guid)){
					$this->_item->positiontype_guid = JArrayHelper::fromObject($this->_item->positiontype_guid);
				}
				$values = (is_array($this->_item->positiontype_guid)) ? $this->_item->positiontype_guid : explode(',',$this->_item->positiontype_guid);
			...
			$this->_item->positiontype_guid = !empty($textValue) ? implode(', ', $textValue) : $this->_item->positiontype_guid;
