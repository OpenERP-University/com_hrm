 ...
 */
class HrmControllerEmployee extends HrmController {
    ...
    public function edit() {
        ...
        // Get the model.
        $model = $this->getModel('Employee', 'HrmModel');
    ...
    public function publish() {
        ...
        if ($user->authorise('core.edit', 'com_hrm') || $user->authorise('core.edit.state', 'com_hrm')) {
            ...
            if (!$item) {
                ...
                $this->setRedirect(JRoute::_('index.php?option=com_hrm&view=employees', false));
            } else {
