...
<div class="department-edit front-end-edit">
    ...
    <form id="form-department" action="<?php echo JRoute::_('index.php?option=com_hrm&task=department.save'); ?>" method="post" class="form-validate form-horizontal" enctype="multipart/form-data">
        ...
        <?php endforeach; ?>				<div class="fltlft" <?php if (!JFactory::getUser()->authorise('core.admin', 'hrm')): ?> style="display:none;" <?php endif; ?> >
