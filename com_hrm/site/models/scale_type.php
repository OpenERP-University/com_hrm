 ...
 * Hrm model.
 */
class HrmModelScale_type extends JModelItem {
	...
	public function getListScale($scale_group_guid = NULL) {
        ...
        if ($scale_group_guid) {
            ...
            $query
                    ...
                    ->from('`#__hrm_scale_type`')
                    ->where($db->quoteName('scale_group_guid') . ' = ' . $db->quote($db->escape($scale_group_guid)));
