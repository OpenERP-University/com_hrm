...
<script type="text/javascript">
    getScript('//ajax.googleapis.com/ajax/libs/jquery/1.9.1/jquery.min.js', function () {
        jQuery(document).ready(function () {
            jQuery('#form-historyitself').submit(function (event) {
...
<div class="historyitself-edit front-end-edit">
    ...
    <form id="form-historyitself" action="<?php echo JRoute::_('index.php?option=com_hrm&task=historyitself.save'); ?>" method="post" class="form-validate form-horizontal" enctype="multipart/form-data">
        ...
        <?php if (!JFactory::getUser()->authorise('core.admin', 'hrm')): ?>
            <script type="text/javascript">
                ...
                jQuery('.tab-pane select').each(function () {
                    ...
                    document.getElementById("form-historyitself").appendChild(input);
                });
            </script>
        <?php endif; ?>
        ...
        <input type="hidden" name="task" value="historyitselfform.save" />
