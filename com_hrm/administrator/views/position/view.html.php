 ...
 * View to edit
 */
class HrmViewPosition extends JViewLegacy {
    ...
    protected function addToolbar() {
        ...
        JToolBarHelper::title(JText::_('COM_HRM_TITLE_POSITION'), 'position.png');
        ...
        if (empty($this->item->id)) {
            ...
            if ($this->state->params->get('save_history', 0) && $user->authorise('core.edit')) {
                JToolbarHelper::versions('com_hrm.position', $this->item->id);
            }
