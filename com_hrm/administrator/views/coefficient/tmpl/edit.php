...
<script type="text/javascript">
    ...
    {
        if (task == 'coefficient.cancel') {
            Joomla.submitform(task, document.getElementById('coefficient-form'));
        }
        else {

            if (task != 'coefficient.cancel' && document.formvalidator.isValid(document.id('coefficient-form'))) {
...
<form action="<?php echo JRoute::_('index.php?option=com_hrm&layout=edit&id=' . (int) $this->item->id); ?>" method="post" enctype="multipart/form-data" name="adminForm" id="coefficient-form" class="form-validate">
