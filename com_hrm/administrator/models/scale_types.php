 ...
 */
class HrmModelScale_types extends JModelList {
    ...
    protected function getListQuery() {
        ...
        $query->from('`#__hrm_scale_type` AS a');
        ...
        if (!empty($search)) {
            if (stripos($search, 'id:') === 0) {
                ...
                $query->where('( a.title LIKE '.$search.'  OR  a.code LIKE '.$search.'  OR  a.scale_group_guid LIKE '.$search.' )');
            }
        }
